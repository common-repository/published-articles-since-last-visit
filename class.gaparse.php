...
class GA_Parse
{
  ...
  $this->first_visit = date("Y-m-d H:i",$time_initial_visit);
  $this->previous_visit = date("Y-m-d H:i",$time_beginning_previous_visit);
  $this->current_visit_started = date("Y-m-d H:i",$time_beginning_current_visit);
